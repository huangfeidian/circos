...
int main()
{
	...
	/*Arc arc(300, 0, 1.57, Point(400, 400), Color(0, 255, 100),0,1.0,4);*/
	Arc arc_1(360, PI / 6, PI / 3, center, Color(128, 128, 128));
	Arc arc_2(360, PI*2 / 3, PI*5/ 6, center, Color(128, 128, 128));
	Arc arc_3(360, PI * 5 / 6, PI * 2 / 3, center, Color(128, 128, 128));
